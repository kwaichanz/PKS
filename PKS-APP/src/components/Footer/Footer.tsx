    ...
    <>
      ...
      >
        <div className=" ">
          ...
          <a className="link link-hover">Career Center</a>
        </div>
        <div>
          <span className="footer-title">Coffee & Tea at home</span>
          <a className="link link-hover">Cofee Story</a>
          <a className="link link-hover">At home</a>
          <a className="link link-hover">How to Brew</a>
          <a className="link link-hover">Coffee Workshop</a>
        </div>
        <div>
      ...
      <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
        <div className="items-center grid-flow-col">
          ...
          <p>
            PKS Industries Ltd. <br />
            Providing reliable beverage since 1992
          </p>
        </div>
